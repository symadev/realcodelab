...
const Navbar = () => {
  ...
  return (
    <nav className="relative">
      {/* Top Navigation Bar */}
      <div className="navbar sticky bg-gradient-to-r from-[#301536d3] via-[#37016a] to-[#0f1f60] backdrop-blur-md bg-opacity-95 text-white px-6 py-3 top-0 z-50 shadow-2xl border-b border-white/10">
        ...
        <ul className="hidden lg:flex gap-8 items-center">
          ...
          <li>
            <Link
              to="/login"
              className="relative text-white btn btn-secondary hover:text-yellow-400 text-[16px] font-medium transition-all duration-300 group"
            >
